...
export class Migration1714429757701 implements MigrationInterface {
    name = 'Migration1714429757701'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "activities" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "timestampMs" bigint NOT NULL, "userId" integer, CONSTRAINT "PK_7f4004429f731ffb9c88eb486a8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "notification_tokens" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "deviceUniqueId" character varying NOT NULL, "userId" integer, CONSTRAINT "PK_2f7d7b15525f17c7123e6422d28" PRIMARY KEY ("id"))`);
